...
document.querySelector('#inquiryForm').addEventListener('submit',e=>{e.preventDefault();const note=document.querySelector('#formNote');note.textContent='Thank you — your inquiry has been captured in this preview. Connect Formspree, HoneyBook, Pixieset, or your email before publishing.';note.style.color='#c9a85d';});
